...
export default function DeleteEmployeeModal({ open, onOpenChange, employee }) {
  ...
  const handleDelete = async () => {
    ...
    try {
      ...
      if (!res.ok) {
        throw new Error(data.message || "Cannot delete employee")
      }
      ...
      >
        ...
        <div className="space-y-4 p-5 sm:p-6">
          ...
          <p className="text-sm leading-6 text-slate-600">
            Are you sure you want to delete this staff account? The employee will no longer be available in the system.
          </p>
